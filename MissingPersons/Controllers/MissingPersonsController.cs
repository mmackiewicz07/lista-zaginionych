...
namespace MissingPersons.Controllers
{
    public class MissingPersonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Name,SecondName,Surname,DateOfBirth,EyeColor,Height,DistinguishingMarks,LastSeenDate,LastSeenPlace,Picture")] MissingPerson missingPerson)
        {
